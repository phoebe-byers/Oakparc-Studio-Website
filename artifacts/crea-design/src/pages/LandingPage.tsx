        ...
        <div className="max-w-6xl mx-auto space-y-0">
          ...
          <div id="project-oak-park" className="border-t border-[#d8d1c7] pt-14 pb-16">
            ...
            <p className="font-serif-display text-[1.05rem] font-light leading-[1.65] text-[#5a5047] mb-8 max-w-2xl">
              A down-to-the-studs renovation of an original 1960s San Francisco home, blending structural improvements with thoughtful design — including a reworked layout, a first floor expansion conceived as an independent short-term rental suite, new systems throughout, and full finish and fixture selection.
            </p>
